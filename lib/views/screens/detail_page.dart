...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: (Get.isDarkMode) ? Colors.blueGrey.shade200 : Colors.blueGrey.shade100,
      appBar: AppBar(
        leadingWidth: 100,
        leading: Padding(
        ...
        foregroundColor: (Get.isDarkMode) ? Colors.blueGrey.shade200 : Colors.blueGrey.shade100,
        backgroundColor: (Get.isDarkMode) ? Colors.blueGrey.shade200 : Colors.blueGrey.shade100,
        elevation: 0,
        bottomOpacity: 0.0,
                        ...
                        child: StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasError) {
                              ...
                              List<QueryDocumentSnapshot<Map<String, dynamic>>> allFav = favourite!.docs;
